...
import com.H5PlusPlugin.PGPluginFirst;
import com.vnbig.android.vnbigas.CusView.MyProgressView;
...
public class SDK_WebApp extends Activity {
    ...
    MyProgressView mpv;//等待框
    BroadcastReceiver brApp;//广播
    IntentFilter infBr;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_vnbig_app_activity);
        ViewGroup rootView = findViewById(R.id.rootview);
        //加载等待框
        mpv = this.findViewById(R.id.myprogressview);
        mpv.show();
...
//            setContentView(f);
        ...
        infBr = new IntentFilter(PGPluginFirst.BR_ACTION_CLOSE);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        Log.w("SDK_WebApp", "_ret = " + _ret + " keyCode =" + keyCode + ",event =" + event);
